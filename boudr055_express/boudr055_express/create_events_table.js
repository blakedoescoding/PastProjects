...
var con = mysql.createConnection({
    ...
    user: "C4131S24NU10",               // replace with the database user provided to you
    password: "150",                  // replace with the database password provided to you
    database: "C4131S24NU10",           // replace with the database user provided to you
    port: 3306
});
